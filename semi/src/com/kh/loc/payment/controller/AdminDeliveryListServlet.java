...
/**
 * Servlet implementation class AdminDeliveryListServlet
 */
@WebServlet("/dLIst.admin")
public class AdminDeliveryListServlet extends HttpServlet {
     ...
     */
    public AdminDeliveryListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userId != null) { 
            //로그인한 상태이면 실행
            ArrayList<Payment> list = ps.adminPaymentList();
    		...
    		if(hmap.get("list") != null) {
    			...
    			page = "views/product/admin_productManage.jsp";
    		} else {
