...
import com.kh.loc.board.model.vo.PageInfo;
...
public class BoardSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 수 가져오기
		int listCount = bs.getSearchListCount(currentPage,limit,condition,keyword);
		...
		list = bs.searchBoard(condition, keyword, currentPage, limit);
		...
		if(list != null) {
			...
			PageInfo pi = new PageInfo(currentPage, listCount, limit, 
	                   maxPage, startPage, endPage,condition,keyword);
			...
			request.setAttribute("error-msg", "게시판 검색 실패!");
