...
public class BoardSelectListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 수 가져오기
		int listCount = bs.getListCount(currentPage,limit, request.getParameter("condition"), request.getParameter("keyword"));
		...
		if(list != null) {
			...
			PageInfo pi = new PageInfo(currentPage, listCount, limit, 
					                   maxPage, startPage, endPage,request.getParameter("condition"), request.getParameter("keyword"));
