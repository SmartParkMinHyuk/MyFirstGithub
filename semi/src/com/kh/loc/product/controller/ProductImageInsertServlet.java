 ...
 */
@WebServlet("/pdImgInsert.pd")
public class ProductImageInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ProductImageInsertServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String savePath = root + "/productUploadFiles/desc/";
		...
		if (originFileName != null) {
			...
			out.print("http://localhost:8088/loc/resources/images/productUploadFiles/desc/" + renameFileName);
			out.flush();
			out.close();
		}
